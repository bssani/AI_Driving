...
AAI_DrivingSportsCar::AAI_DrivingSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAI_DrivingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAI_DrivingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAI_DrivingSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAI_DrivingSportsWheelRear::StaticClass();
