...
#include "AI_DrivingPlayerController.generated.h"

class UInputMappingContext;
class AAI_DrivingPawn;
class UAI_DrivingUI;
...
class AAI_DrivingPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AAI_DrivingPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AAI_DrivingPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UAI_DrivingUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UAI_DrivingUI> VehicleUI;
