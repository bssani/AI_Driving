...
#include "AI_DrivingOffroadCar.h"
#include "AI_DrivingOffroadWheelFront.h"
#include "AI_DrivingOffroadWheelRear.h"
...
AAI_DrivingOffroadCar::AAI_DrivingOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAI_DrivingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAI_DrivingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAI_DrivingOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAI_DrivingOffroadWheelRear::StaticClass();
